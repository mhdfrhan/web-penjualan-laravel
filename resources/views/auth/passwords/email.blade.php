...
<section class="py-20 px-4">
    <div class="max-w-md mx-auto py-8 px-8 shadow rounded-xl">
        ...
        <div class="text-center mt-4">
            <h1 class="text-xl md:text-2xl font-medium">Lupa password?</h1>
            <p class="text-[13px] text-gray-400 mt-2">Jangan khawatir, kami akan mengirimkan instruksi penyetelan ulang.
            </p>
        </div>
        <div class="mt-8">
					@if (session('status'))
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <div class="relative">
                    <input type="email" id="email" name="email"
                        ...
                        autocomplete="off" placeholder=" " required value="{{ old('email') }}"><label for="email"
