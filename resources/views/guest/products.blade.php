        ...
        <div class="container mx-auto px-4 lg:px-20">
            ...
            <div class="flex flex-wrap items-center justify-between mb-10">
                <div class="w-full lg:w-1/2 mb-6 lg:mb-0 overflow-hidden">
                    <h1 class="capitalize text-2xl lg:text-3xl font-semibold" data-aos="fade-right" data-aos-duration="1000">Semua produk</h1>
                </div>
                <div class="w-full lg:w-1/3 overflow-hidden">
                    <form action="/products" method="GET" class="flex items-center w-full" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="150"><label for="search"
            ...
            <div class="flex flex-wrap -mx-4">
                @foreach ($barang as $b)
                    <div class="w-full md:w-1/2 lg:w-1/3 2xl:w-1/4 p-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="{{ $loop->iteration * 100 }}">
                        <div
                            ...
                            <div class="mt-6">
                                ...
                                <div class="absolute top-3 right-3 lg:translate-x-14 group-hover:translate-x-0 duration-500">
																			<form action="{{ route('tambah.favorit', $b->slug) }}" method="POST">
																					...
																					<input type="hidden" name="id_produk" value="{{ $b->id }}">
																					<button type="submit"
																							class="bg-violet-600 shadow-lg shadow-violet-500/50 hover:bg-violet-700 text-violet-100 rounded-xl text-sm ml-2 w-10 h-10 flex items-center justify-center font-medium tracking-wide"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
