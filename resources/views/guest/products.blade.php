        ...
        <div class="container mx-auto px-4 lg:px-20">
            ...
            <div class="flex flex-wrap items-center justify-between mb-10">
                <div class="w-full lg:w-1/2 mb-6 lg:mb-0">
                    <h1 class="capitalize text-2xl lg:text-3xl font-semibold">Semua produk</h1>
                </div>
                <div class="w-full lg:w-1/3">
                    <form action="/products" method="GET" class="flex items-center w-full"><label for="search"
                ...
                @foreach ($barang as $b)
                    <div class="w-full md:w-1/2 lg:w-1/3 2xl:w-1/4 p-4">
                        <div
                            ...
                            @if ($b->image)
                                <img src="{{ asset('storage/' . $b->image) }}" class="mx-auto rounded-lg h-44 object-cover"
                            ...
                            <div class="mt-6">
                                ...
                                <div class="absolute top-3 right-3 translate-x-14 group-hover:translate-x-0 duration-500">
