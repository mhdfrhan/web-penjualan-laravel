...
@section('container')
    ...
    <section class="py-16">
        <div class="container mx-auto px-5 lg:px-20">
            ...
            <div class="pb-16">
                <h1 class="capitalize text-2xl lg:text-3xl font-semibold mb-6">Kategori</h1>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-8">
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            class="inline bg-white border border-gray-200 text-center font-medium py-8 hover:bg-gray-100 duration-500 ">
                            {{ $category->name }}
                        </a>
                    @endforeach
                </div>
            ...
            <section class="pb-16">
                <h1 class="capitalize text-2xl lg:text-3xl font-semibold mb-6">Produk baru</h1>
                            ...
                            <div
                                ...
                                @if ($b->image)
                                    <img src="{{ asset('storage/' . $b->image) }}"
                                        class="mx-auto rounded-lg h-44 object-cover" alt="gambar {{ $b->merk_brg }}">
                                @else
                                ...
                                <div class="mt-6">
                                    ...
                                    <div
                                        class="absolute top-3 right-3 translate-x-14 group-hover:translate-x-0 duration-500">
                ...
                <div class="text-center mt-10">
                    <a href="/products"
                        class="inline border border-violet-600 text-violet-600 py-3 px-10 rounded-lg hover:bg-violet-600 hover:text-white duration-300">Semua
                        produk</a>
                </div>
            </section>
