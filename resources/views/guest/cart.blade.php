    ...
    <section class="py-16">
        ...
        <div class="container mx-auto px-4 lg:px-20 overflow-hidden">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full lg:w-2/3 p-4" data-aos="fade-right" data-aos-duration="1000">
                                ...
                                <div class="flex items-start w-full  sm:w-2/5 mb-4 sm:mb-0">
                                    ...
                                    @if ($item->image)
                                        ...
                                        <a class="cursor-pointer" data-fancybox
                                            ...
                                            data-src="{{ asset('img/' . $item->image) }}">

                                            <img src="{{ asset('img/' . $item->image) }}" class="inline w-24 h-24 object-cover rounded-lg"
                                    ...
                                    <div class="ml-6">
                                        ...
                                        <h5 class="text-lg font-medium">{{ $item->merk_brg }}</h5>
																				...
																				<p class="text-sm text-gray-400">stok {{ $item->stok_brg }}</p>

                                        <span class="inline text-lg text-violet-600 font-medium">Rp.
                ...
                <div class="w-full lg:w-1/3 p-4" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="50">
