...
@section('container')
    ...
    <section class="py-16 px-4">
        ...
        <div class="max-w-2xl mx-auto shadow p-6 sm:p-10 rounded-lg mb-10 overflow-hidden">

            <h1 class="mb-8 text-[22px] sm:text-2xl font-medium" data-aos="fade-right" data-aos-duration="1000">Profile {{ Auth::user()->name }}</h1>
            ...
            <form action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-6" data-aos="fade-up" data-aos-duration="1000">

                    @if ($user->image)

                        <img src="{{ asset('img/user/' . $user->image) }}" class="w-40 mb-2 img-preview rounded-lg" alt="">

                    @else

                        <img class="w-40 img-preview rounded-lg mb-2" src="{{ asset('img/no-photo.png') }}" alt="">
                    ...
                    @enderror
								...
								<div class="overflow-hidden">
									...
									<a href="{{ route('foto.hapus', $user->slug) }}" class="text-end block mt-2 text-red-600 hover:underline" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000">Hapus foto</a>
                ...
                <div class="mt-6 overflow-hidden">
                    ...
                    <div class="relative" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="150">
                ...
                <div class="flex items-center justify-end gap-4 mt-4 overflow-hidden">

                    <button type="submit"

                        class="px-4 py-2.5 bg-gradient-to-b from-violet-500 to-violet-600 text-white rounded-lg shadow-lg shadow-violet-600/30 mt-4 hover:scale-105 duration-500" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">Update
        ...
        <div class="max-w-2xl mx-auto shadow p-10 rounded-lg overflow-hidden">

            <div class="mb-8 overflow-hidden">

                <h1 class="text-2xl font-medium" data-aos="fade-right" data-aos-duration="1000">Hapus akun</h1>

                <p class="mt-2 text-sm text-gray-400" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">Menghapus akun akan membuat semua data Anda akan dihapus permanen</p>

            </div>

            <button class="bg-red-600 py-2.5 text-white px-10 rounded-lg btnHapusAKun" data-modal-target="hapus-modal"

                data-modal-toggle="hapus-modal" data-aos="fade-up" data-aos-duration="1000">Hapus</button>
