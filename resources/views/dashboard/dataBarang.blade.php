...
@section('container')
    <section class="pb-16">
        <div class="mb-4">
            <h3 class="text-gray-800 text-2xl font-semibold">Data Barang</h3>
        </div>
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="/dashboard/dataBarang/produk" method="POST" enctype="multipart/form-data">@csrf
                                <div>
                                    <div class="relative"><input type="text" id="jenis_brg" name="jenis_brg"
                                            class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('jenis_brg') !border-red-600 @enderror"
                                            autocomplete="off" placeholder=" " required
                                            value="{{ old('jenis_brg') }}"><label for="jenis_brg"
                                            class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white  px-2 peer-focus:px-2 peer-focus:text-violet-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 @error('jenis_brg') !text-red-600 @enderror">Jenis
                                            barang</label></div>
                                    @error('jenis_brg')
                                ...
                                <div class="my-6">
                                    <div class="relative"><input type="text" id="merk_brg" name="merk_brg"
                                            class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('merk_brg') !border-red-600 @enderror"
                                ...
                                <div class="grid lg:grid-cols-2 gap-6">
                                    <div>
                                        <div class="relative"><input type="text" id="stok_brg" name="stok_brg"
                                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('stok_brg') !border-red-600 @enderror"
                                                autocomplete="off" placeholder=" " required
                                    ...
                                    <div>
                                        <div class="relative"><input type="text" id="harga_brg" name="harga_brg"
                                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('harga_brg') !border-red-600 @enderror"
                                                autocomplete="off" placeholder=" " required
                                    ...
                                    @if ($b->image)
                                        <a class="cursor-pointer" data-fancybox
                                            ...
                                            <img src="{{ asset('storage/' . $b->image) }}"
                                                class="inline w-24 rounded-lg h-auto" alt="gambar {{ $b->jenis_brg }}">
                                        </a>
                                    @else
                                ...
                                <td>
                                    <div class="flex items-center gap-x-3">
                                        <div><button class="editBtn" data-modal-target="updateModal"
                                                data-modal-toggle="updateModal" value="{{ $b->id }}"><svg
                                        ...
                                        <div>
                                            <form action="/dashboard/dataBarang/produk/{{ $b->id }}"
                                                method="POST" id="formHapus">@method('delete') @csrf<button
                                                    type="submit" data-modal-target="hapusModal"
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        <div class="flex items-start justify-between p-4 border-b rounded-t ">
                            <h3 class="text-xl font-semibold text-gray-900 ">Update barang</h3><button type="button"
                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center "
                                data-modal-hide="updateModal"><svg class="w-5 h-5" fill="currentColor"
                        ...
                        <div class="p-6 space-y-6">
                            <form action="/dashboard/dataBarang/produk/" method="POST" id="formUpdate">@csrf
                                @method('PUT')<div><input type="hidden" name="id_barang" id="id_barang"
                                        value="">
                                    <div class="relative"><input type="text" id="jenis_brg" name="jenis_brg"
                                            class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('jenis_brg') !border-red-600 @enderror"
                                            autocomplete="off" placeholder=" " required
                                ...
                                <div class="my-6">
                                    <div class="relative"><input type="text" id="merk_brg" name="merk_brg"
                                            class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-violet-600 peer @error('merk_brg') !border-red-600 @enderror"
                                            autocomplete="off" placeholder=" " required
                                            value="{{ old('merk_brg') }}"><label for="merk_brg"
                                            class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white  px-2 peer-focus:px-2 peer-focus:text-violet-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 @error('merk_brg') !text-red-600 @enderror">Merk
                                            barang</label></div>
                                    @error('merk_brg')
                                        <span class="text-sm text-red-600">{{ $message }}</span>
                        ...
                        <div class="p-6 text-center"><svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14"
                            ...
                            <form action="" method="POST" id="formHapusModal">@method('delete') @csrf<button
                                    ...
                                    id="modalHapusBtn">Ya, Saya yakin</button>
																		<button data-modal-hide="hapusModal"
                                    type="button"
