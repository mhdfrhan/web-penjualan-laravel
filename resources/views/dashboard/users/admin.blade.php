    ...
    <section>
        <div class="flex flex-wrap items-center justify-between mb-8">
            ...
            <div id="tambahModal" tabindex="-1" aria-hidden="true"
                class="fixed top-0 left-0 right-0 z-50 hidden items-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-black bg-opacity-50">
                <div class="relative h-full w-full flex flex-col justify-center max-w-xl animate__animated animate__zoomIn animate__faster">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="{{ route('admin.tambah') }}" method="POST" enctype="multipart/form-data"> @csrf
                        ...
                        <tr>
                            ...
                            <td scope="row">
                                @if ($a->image)
                                    <a class="cursor-pointer" data-fancybox
                                        data-src="{{ asset('img/user/' . $a->image) }}"> <img
                                            src="{{ asset('img/user/' . $a->image) }}"
                                            class="inline w-24 rounded-lg h-auto" alt="gambar{{ $a->name }}"> </a>
                                @else
                            ...
                            <td>
                                <div class="flex items-center gap-x-2">
                                    <div>
                                        <form action="{{ route('user.edit', $a->slug) }}" method="GET"> @csrf <button
