                ...
                <div class="relative w-full h-full max-w-xl md:h-auto mx-auto">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="{{ route('pembeli.tambah') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="flex items-center justify-end gap-4 mt-4"><button type="button"
                                        ...
                                        type="submit"
                                        class="px-4 py-2.5 bg-gradient-to-b from-violet-500 to-violet-600 text-white rounded-lg shadow-lg shadow-violet-600/30 mt-4 hover:scale-105 duration-500">Tambah</button></div>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                                ...
                                @if ($p->image)
                                    <a class="cursor-pointer" data-fancybox
                                        ...
                                        <img src="{{ asset('storage/' . $p->image) }}"
                                            class="inline w-24 rounded-lg h-auto" alt="gambar {{ $p->name }}">
                                    </a>
                                @else
                            ...
                            <td>
                                <div class="flex items-center gap-x-2">
                                    ...
                                    <div>
                                        <form action="{{ route('user.edit', $p->slug) }}" method="GET">
                                            @csrf
