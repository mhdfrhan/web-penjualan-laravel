...
@section('container')
    <div class="flex flex-wrap -mx-4">
                                        ...
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <div>
                                                ...
                                                <button class="editBtn2" data-modal-target="updateModal"
                                                    data-modal-toggle="updateModal" value="{{ $category->id }}"
        ...
        <div id="hapusModal" tabindex="-1" aria-hidden="true"
            class="fixed z-[999] hidden items-center justify-center w-full overflow-x-hidden overflow-y-auto inset-0 h-screen bg-black bg-opacity-80 px-4">
