...
@section('container')
    ...
    <section class="max-w-2xl rounded-lg p-6">
        ...
        <form action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6">
                ...
                @enderror
						...
						<div>
							...
							<a href="{{ route('foto.hapus', $user->slug) }}" class="text-end block mt-2 text-red-600 hover:underline">Hapus foto</a>
            ...
            <div class="flex items-center justify-end gap-4 mt-4">
                ...
                <a href="/dashboard/users/admin" type="button"
				...
				<div class="max-w-2xl mx-auto border p-10 rounded-lg mt-10">
