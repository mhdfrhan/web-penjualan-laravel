        ...
        <form action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-end gap-4 mt-4">
                <a href="/dashboard/users/admin" type="button"
                    class="px-6 py-2.5 bg-gradient-to-b from-red-500 to-red-600 text-white rounded-lg shadow-md shadow-red-600/30 mt-4 hover:scale-105 duration-500">Batal</a>
                <button type="submit"
